      ...
      <main className="flex items-center w-full">
        <Layout>
          <div className="relative">
            <h1 className="absolute text-4xl font-extrabold uppercase text-gray-50 left-1/4 top-1/4">Latest song is available now</h1>
            <Link href="/discography" className="absolute text-1xl text-gray-50 left-1/4 top-1/2 hover:text-sky-400">Browser other songs here</Link>
